...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # they keep checking over and over, not terminating until it can't match anymore. Like a greedy alogorithm
  ...
  # I guess if you have repeat operators it means repeat of one specific choice of ors
  # rather than repeat of any in range
